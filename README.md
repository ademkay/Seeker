...
Added Google API search function (no bans for frequent requests). Paste your API key and search engine ID to .txt files in google_api folder. To switch between search modes find line 91 in seeker.py and comment/uncomment ones (working on more adequate switching now). Defaultly set on non-API search.
